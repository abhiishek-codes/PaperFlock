      ...
      >
        <div className="flex flex-col gap-y-2">
          ...
          <input
            ...
            className="w-full border-gray-300 bg-white text-gray-800 focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-200 text-sm rounded-md p-2"
            value={email}
